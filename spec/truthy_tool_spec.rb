...
RSpec.describe TruthyTool do
  ...
  describe ".is_truthy??" do
    ...
    it { expect(described_class.is_truthy?(42)).to be_truthy}  # true
    it { expect(described_class.is_truthy?([])).to eq(false) } # false
    it { expect(described_class.is_truthy?([1])).to be_truthy}  # true
    it { expect(described_class.is_truthy?([1, 5])).to be_truthy}  # true
    it { expect(described_class.is_truthy?({})).to eq(false) } # false
    it { expect(described_class.is_truthy?({a: :b})).to be_truthy}  # true
    end
end
